...
import Lumileds.test.constants.LumiledsTestConstants;
import Lumileds.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LumiledsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/Lumiledstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/Lumiledstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/Lumiledstest/import/cstickets.impex");
			...
			importImpexFile(context, "/Lumiledstest/import/csquotes.impex");
		}
	}
}
