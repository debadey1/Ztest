 ...
 */
package Lumileds.core.constants;

/**
 * Global class for all LumiledsCore constants. You can add global constants for your extension into this class.
 */
public final class LumiledsCoreConstants extends GeneratedLumiledsCoreConstants
{
	public static final String EXTENSIONNAME = "Lumiledscore";


	private LumiledsCoreConstants()
	{
		//empty
	}
