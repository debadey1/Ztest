 ...
 */
package Lumileds.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(LumiledsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LumiledsFulfilmentProcessConstants.PARENT_PROCESS);
